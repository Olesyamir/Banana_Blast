...
public class InGameScreen : Screen
{
    ...
    {
        Console.WriteLine("Chargement Appelé ");
        Texture2D shipTexture = Global._game.Content.Load < Texture2D >("ship2") ;
        _ship = new Player( shipTexture , new Vector2 (250 , 720),150 ) ;
...
{
    Console.WriteLine("Update Appelé ");
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        if (Instance is InGameScreen)
        {
            Console.WriteLine("Dessin fait");
